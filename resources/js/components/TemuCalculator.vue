<template>
    <div class=" max-w-[460px] w-full relative shadow-2xl shadow-[#FB7701]  bg-white  rounded-2xl ">
                    <div class=" w-full relative rounded-t-2xl overflow-hidden ">
                        <div class=" w-full bg-[#FB7701] flex">
                        ...
                        <div class=" w-full absolute top-5 flex flex-col items-center space-y-4 left-0 py-2">
                            <h1 class=" text-white text-5xl uppercase font-bold">temu</h1>
                    ...
                    <div class=" w-full flex pt-4 pb-20" v-if="loading">
                        <div role="status" class=" m-auto">
                            <svg aria-hidden="true" class="w-8 h-8 mr-2 text-[#FB7701] animate-spin  fill-orange-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class=" pt-10 pb-20 px-4 w-full grid grid-cols-2 gap-5" v-if="show && !loading">
                        ...
                        <div class=" flex flex-col items-start space-y-2">
                            <span class=" text-xl font-bold text-[#FB7701] ">Customs and Duties:</span>
                    ...
                    <div class=" w-full absolute -bottom-8 px-4 left-0">
                        <button @click="Calculate" class=" w-full h-20 text-center bg-[#FB7701] hover:bg-orange-600 duration-200 text-white rounded-xl text-2xl font-medium">Send</button>
                    </div>
                </div>
</template>
