...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Kimberly Personal Ordering Services</title>

        {{-- og tags --}}
        <meta property="og:title" content="Kimberly Personal Ordering Services" />
        <meta property="og:description" content="Welcome to Kimberly Personal Ordering Services! In a fast-paced world where convenience is key, we revolutionize your online ordering experience. Our dedicated team ensures that your needs and preferences are met . With our user-friendly calculator , you can effortlessly see how much it will cost to order your packages. Say goodbye to the hassle and wasted hours—and enjoy the stress-free, personalized, and reliable online ordering with Kimberly Personal Ordering Services." />
        <meta property="og:image" content="{{asset('images/FA3BBC56-BF36-4D68-A48F-88DB215426E4.jpeg')}}" />
        <meta property="og:url" content="https://kimberlyorderingservices.com" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Kimberly Personal Ordering Services" />
        <meta property="og:locale" content="en_US" />
        {{-- twitter tags --}}
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:site" content="@kimberlyorderingservices">
        <meta name="twitter:creator" content="@kimberlyorderingservices">
        <meta name="twitter:title" content="Kimberly Personal Ordering Services">
        <meta name="twitter:description" content="Welcome to Kimberly Personal Ordering Services! In a fast-paced world where convenience is key, we revolutionize your online ordering experience. Our dedicated team ensures that your needs and preferences are met . With our user-friendly calculator , you can effortlessly see how much it will cost to order your packages. Say goodbye to the hassle and wasted hours—and enjoy the stress-free, personalized, and reliable online ordering with Kimberly Personal Ordering Services.">
        <meta name="twitter:image" content="{{asset('images/FA3BBC56-BF36-4D68-A48F-88DB215426E4.jpeg')}}">
        <meta name="twitter:image:alt" content="Kimberly Personal Ordering Services">
        

        {{-- Seo --}}
        <meta name="description" content="Welcome to Kimberly Personal Ordering Services! In a fast-paced world where convenience is key, we revolutionize your online ordering experience. Our dedicated team ensures that your needs and preferences are met . With our user-friendly calculator , you can effortlessly see how much it will cost to order your packages. Say goodbye to the hassle and wasted hours—and enjoy the stress-free, personalized, and reliable online ordering with Kimberly Personal Ordering Services.">
        <meta name="keywords" content="Kimberly Personal Ordering Services, kimberly ordering services, kimberly order, kimberly order services, kimberly personal ordering services, kimberly personal order, kimberly personal order services, kimberly personal ordering services trinidad, kimberly personal order trinidad, kimberly personal order services trinidad, kimberly personal ordering services tobago, kimberly personal order tobago, kimberly personal order services tobago, kimberly personal ordering services trinidad and tobago, kimberly personal order trinidad and tobago, kimberly personal order services trinidad and tobago, kimberly personal ordering services trinidad and tobago, kimberly personal order trinidad and tobago, kimberly personal order services trinidad and tobago, kimberly personal ordering services trinidad and tobago, kimberly personal order trinidad and tobago, kimberly personal order services trinidad and tobago">
        <meta name="author" content="Kimberly Personal Ordering Services">
        ...
        <meta name="msapplication-TileImage" content="{{asset('images/favicon.jpeg')}}">
        <meta name="msapplication-config" content="{{asset('images/favicon.jpeg')}}">
        <meta name="apple-mobile-web-app-title" content="Kimberly Personal Ordering Services">
        <meta name="application-name" content="Kimberly Personal Ordering Services">
        <meta name="msapplication-tooltip" content="Kimberly Personal Ordering Services">
    ...
    <body class="antialiased pb-10 space-y-20 sm:space-y-40 ">
      ...
      <div class=" w-full p-2 md:p-10">
        <div class=" w-full pt-7 md:pt-[100px] pb-7 md:pb-[175px] overflow-hidden px-8 bg-gradient-to-r from-orange-600 to-orange-300 rounded-xl md:rounded-[50px]" >
            <div class=" w-full max-w-[1140px] space-y-10 lg:space-y-0 mx-auto flex justify-center  lg:justify-between flex-wrap relative">
                <div class=" flex flex-col items-center md:items-start space-y-5 lg:max-w-[665px] w-full ">
                    ...
                    <div class=" flex items-center space-x-2 pt-10">
                     <span class="text-white text-base sm:text-2xl font-bold"> Find us on Instagram</span>
                      <a href="https://instagram.com/kimberly_personal_ordering" target="_blank">
                        <img src="{{asset('images/instagram.png')}}" class=" w-[60px]" alt="">
                      </a>
                    </div>
                </div>
                <div class="  pt-10 lg:pt-0">
                    <img src="{{asset('images/header-right-image-home-031616246925.png')}}" class=" max-w-[250px] lg:max-w-2xl lg:absolute top-0 -right-[21rem]" alt="">
                </div>
            </div>
          </div>
      </div>
      ...
      <section class=" w-full max-w-[1140px] mx-auto  pt-56">
        <div class=" w-full relative">
            <div class="  w-full absolute flex -top-[14.5rem] sm:-top-[17rem] ">
                <img src="/images/banco.png" class=" max-w-[300px] sm:max-w-[350px] mx-auto" alt="">
            </div>
      ...
      <section class=" w-full relative px-4 sm:px-0"  id="app">
        ...
        <div class=" w-full max-w-[1440px]  mx-auto  relative space-y-10 sm:space-y-28">
